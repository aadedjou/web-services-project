...
public class ConverterServiceLocator extends org.apache.axis.client.Service implements fr.uge.ifservice.converter.ConverterService {
    ...
    public fr.uge.ifservice.converter.Converter getConverter(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.uge.ifservice.converter.ConverterSoapBindingStub _stub = new fr.uge.ifservice.converter.ConverterSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.uge.ifservice.converter.Converter.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.uge.ifservice.converter.ConverterSoapBindingStub _stub = new fr.uge.ifservice.converter.ConverterSoapBindingStub(new java.net.URL(Converter_address), this);
                _stub.setPortName(getConverterWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://converter", "ConverterService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://converter", "Converter"));
        }
